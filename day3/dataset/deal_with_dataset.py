...
# 数据集路径
dataset_dir = r'G:\py\pythonProjectdemo\day3\dataset\Images'  # 替换为你的数据集路径
train_dir = r'G:\py\pythonProjectdemo\day3\dataset\Images\train'  # 训练集输出路径
val_dir = r'G:\py\pythonProjectdemo\day3\dataset\Images\val'  # 验证集输出路径
